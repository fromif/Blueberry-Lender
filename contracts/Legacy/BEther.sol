...
/**
 * @title Compound's BEther Contract
...
contract BEther is BTokenDeprecated {
     ...
     */
    function liquidateBorrow(address borrower, BTokenDeprecated bTokenCollateral) external payable {
        (uint256 err, ) = liquidateBorrowInternal(borrower, msg.value, bTokenCollateral);
