...
contract BTokenAdmin is Exponential {
     ...
     */
    function _queuePendingAdmin(address bToken, address payable newPendingAdmin) external onlyAdmin {
     ...
     * @param newPendingAdmin The new pending admin
     */
    function _clearPendingAdmin(address bToken, address payable newPendingAdmin) external onlyAdmin {
     ...
     * @param newPendingAdmin The new pending admin
     */
    function _togglePendingAdmin(address bToken, address payable newPendingAdmin) external onlyAdmin returns (uint256) {
     ...
     */
    function _setComptroller(address bToken, ComptrollerInterface newComptroller) external onlyAdmin returns (uint256) {
     ...
     */
    function _setReserveFactor(address bToken, uint256 newReserveFactorMantissa) external onlyAdmin returns (uint256) {
     ...
     */
    function _reduceReserves(address bToken, uint256 reduceAmount) external onlyAdmin returns (uint256) {
     ...
     */
    function _setInterestRateModel(address bToken, InterestRateModel newInterestRateModel)
        external
        onlyAdmin
        returns (uint256)
    {
     ...
     */
    function _setCollateralCap(address bToken, uint256 newCollateralCap) external onlyAdmin {
     ...
     */
    function _queuePendingImplementation(address bToken, address implementation) external onlyAdmin {
     ...
     * @param implementation The new pending implementation
     */
    function _clearPendingImplementation(address bToken, address implementation) external onlyAdmin {
