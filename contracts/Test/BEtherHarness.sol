...
contract BEtherHarness is BEther {
    ...
    ) public BEther(comptroller_, interestRateModel_, initialExchangeRateMantissa, name_, symbol_, decimals_, admin_) {}
    ...
    function harnessRedeemFresh(
        ...
        return super.redeemFresh(account, bTokenAmount, underlyingAmount);
    }
    ...
    function harnessLiquidateBorrowFresh(
        ...
        (uint256 err, ) = liquidateBorrowFresh(liquidator, borrower, repayAmount, bTokenCollateral);
        return err;
    }
...
contract BEtherScenario is BEther {
