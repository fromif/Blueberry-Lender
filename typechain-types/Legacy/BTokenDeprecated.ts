...
export interface BTokenDeprecatedInterface extends utils.Interface {
  functions: {
...
export interface BTokenDeprecated extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BTokenDeprecatedInterface;
