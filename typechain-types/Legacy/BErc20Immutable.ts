...
export interface BErc20ImmutableInterface extends utils.Interface {
  functions: {
...
export interface BErc20Immutable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BErc20ImmutableInterface;
