...
export interface BCapableErc20DelegateInterface extends utils.Interface {
  functions: {
...
export interface BCapableErc20Delegate extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BCapableErc20DelegateInterface;
