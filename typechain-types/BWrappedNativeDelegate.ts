...
export interface BWrappedNativeDelegateInterface extends utils.Interface {
  functions: {
...
export interface BWrappedNativeDelegate extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BWrappedNativeDelegateInterface;
