...
export interface BCapableErc20InterfaceInterface extends utils.Interface {
  functions: {
...
export interface BCapableErc20Interface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BCapableErc20InterfaceInterface;
