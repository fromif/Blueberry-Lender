...
export interface BDelegateInterfaceInterface extends utils.Interface {
  functions: {
...
export interface BDelegateInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BDelegateInterfaceInterface;
