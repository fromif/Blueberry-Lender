...
export interface BDelegatorInterfaceInterface extends utils.Interface {
  functions: {
...
export interface BDelegatorInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BDelegatorInterfaceInterface;
