...
export interface BWrappedNativeInterfaceInterface extends utils.Interface {
  functions: {
...
export interface BWrappedNativeInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BWrappedNativeInterfaceInterface;
