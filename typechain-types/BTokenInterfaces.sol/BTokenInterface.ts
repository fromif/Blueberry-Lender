...
export interface BTokenInterfaceInterface extends utils.Interface {
  functions: {
...
export interface BTokenInterface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BTokenInterfaceInterface;
