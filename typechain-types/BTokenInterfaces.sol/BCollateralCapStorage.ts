...
export interface BCollateralCapStorageInterface extends utils.Interface {
  functions: {
...
export interface BCollateralCapStorage extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BCollateralCapStorageInterface;
