...
export interface BErc20InterfaceInterface extends utils.Interface {
  functions: {
...
export interface BErc20Interface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BErc20InterfaceInterface;
