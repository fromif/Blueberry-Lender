...
export interface BTokenNoInterestInterface extends utils.Interface {
  functions: {
...
export interface BTokenNoInterest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BTokenNoInterestInterface;
