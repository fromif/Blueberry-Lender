...
export interface PriceOracleProxy extends BaseContract {
  ...
  functions: {
    ...
    bEthAddress(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    bEthAddress(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    bEthAddress(overrides?: CallOverrides): Promise<PopulatedTransaction>;
