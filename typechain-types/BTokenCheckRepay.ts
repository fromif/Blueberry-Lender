...
export interface BTokenCheckRepayInterface extends utils.Interface {
  functions: {
...
export interface BTokenCheckRepay extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BTokenCheckRepayInterface;
