...
export interface BErc20DelegatorInterface extends utils.Interface {
  functions: {
...
export interface BErc20Delegator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BErc20DelegatorInterface;
