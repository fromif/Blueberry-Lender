...
export interface FlashloanAndMintInterface extends utils.Interface {
  functions: {
...
export interface FlashloanAndMint extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FlashloanAndMintInterface;
