...
export interface FlashloanAndRepayBorrowNativeInterface
...
export interface FlashloanAndRepayBorrowNative extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FlashloanAndRepayBorrowNativeInterface;
