...
export interface FlashloanAndRepayBorrowInterface extends utils.Interface {
  functions: {
...
export interface FlashloanAndRepayBorrow extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FlashloanAndRepayBorrowInterface;
