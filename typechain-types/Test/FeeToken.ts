...
export interface FeeTokenInterface extends utils.Interface {
  functions: {
    ...
    "basisPointFee()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "basisPointFee",
    values?: undefined
  ): string;
...
export interface FeeToken extends BaseContract {
  ...
  functions: {
    ...
    basisPointFee(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    basisPointFee(overrides?: CallOverrides): Promise<PopulatedTransaction>;
