...
export interface ComptrollerScenarioInterface extends utils.Interface {
  functions: {
    ...
    "_pauseCreditLimit(address,address)": FunctionFragment;
    ...
    "creditLimits(address)": FunctionFragment;
    ...
    "membershipLength(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_pauseCreditLimit",
  ...
  encodeFunctionData(
    functionFragment: "creditLimits(address,address)",
    values: [PromiseOrValue<string>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "creditLimits(address)",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "membershipLength",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "NewBTokenVersion(address,uint8,uint8)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "NewBTokenVersion"): EventFragment;
...
export interface NewBTokenVersionEventObject {
  bToken: string;
  oldVersion: number;
  newVersion: number;
}
export type NewBTokenVersionEvent = TypedEvent<
  [string, number, number],
  NewBTokenVersionEventObject
>;

export type NewBTokenVersionEventFilter =
  TypedEventFilter<NewBTokenVersionEvent>;
...
export interface ComptrollerScenario extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ComptrollerScenarioInterface;
  ...
  filters: {
    ...
    MarketDelisted(bToken?: null, force?: null): MarketDelistedEventFilter;
    ...
    "NewBTokenVersion(address,uint8,uint8)"(
      bToken?: null,
      oldVersion?: null,
      newVersion?: null
    ): NewBTokenVersionEventFilter;
    NewBTokenVersion(
      bToken?: null,
      oldVersion?: null,
      newVersion?: null
