...
export interface BWrappedNativeDelegateScenarioInterface
...
export interface BWrappedNativeDelegateScenario extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BWrappedNativeDelegateScenarioInterface;
