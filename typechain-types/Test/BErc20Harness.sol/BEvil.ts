...
export interface BEvilInterface extends utils.Interface {
  functions: {
    ...
    "evilSeize(address,address,address,uint256)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "evilSeize", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "exchangeRateCurrent",
    data: BytesLike
  ): Result;
...
export interface BEvil extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BEvilInterface;
  ...
  functions: {
    ...
    evilSeize(
      treasure: PromiseOrValue<string>,
