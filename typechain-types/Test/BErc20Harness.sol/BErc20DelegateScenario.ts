...
export interface BErc20DelegateScenarioInterface extends utils.Interface {
  functions: {
...
export interface BErc20DelegateScenario extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BErc20DelegateScenarioInterface;
