...
export interface BWrappedNativeDelegatorScenarioInterface
...
export interface BWrappedNativeDelegatorScenario extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BWrappedNativeDelegatorScenarioInterface;
