...
export interface BErc20DelegateScenarioExtraInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "babyYoda", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "babyYoda", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "itIsTheWay", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "liquidateBorrow",
    data: BytesLike
  ): Result;
...
export interface BErc20DelegateScenarioExtra extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BErc20DelegateScenarioExtraInterface;
  ...
  functions: {
    ...
    babyYoda(overrides?: CallOverrides): Promise<[void]>;
    ...
    iHaveSpoken(overrides?: CallOverrides): Promise<[string]>;
  ...
  callStatic: {
    ...
    itIsTheWay(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    babyYoda(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    iHaveSpoken(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    babyYoda(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    iHaveSpoken(overrides?: CallOverrides): Promise<PopulatedTransaction>;
