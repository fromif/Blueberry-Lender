...
export interface CurveTokenHarnessInterface extends utils.Interface {
  functions: {
...
export interface CurveTokenHarness extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CurveTokenHarnessInterface;
