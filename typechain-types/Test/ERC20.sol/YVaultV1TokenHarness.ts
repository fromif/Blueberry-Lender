...
export interface YVaultV1TokenHarnessInterface extends utils.Interface {
  functions: {
...
export interface YVaultV1TokenHarness extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: YVaultV1TokenHarnessInterface;
