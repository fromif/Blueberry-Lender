...
export interface ComptrollerRopstenInterface extends utils.Interface {
  functions: {
...
export interface ComptrollerRopsten extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ComptrollerRopstenInterface;
