...
export interface BCollateralCapErc20Interface extends utils.Interface {
  functions: {
...
export interface BCollateralCapErc20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BCollateralCapErc20Interface;
