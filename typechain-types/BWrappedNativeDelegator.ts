...
export interface BWrappedNativeDelegatorInterface extends utils.Interface {
  functions: {
...
export interface BWrappedNativeDelegator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BWrappedNativeDelegatorInterface;
