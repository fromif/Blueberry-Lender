...
export interface BTokenMethods {
...
export interface BTokenScenarioMethods extends BTokenMethods {
  setTotalBorrows(amount: encodedNumber): Sendable<void>;
  setTotalReserves(amount: encodedNumber): Sendable<void>;
}

export interface BToken extends Contract {
  methods: BTokenMethods;
  name: string;
}

export interface BTokenScenario extends Contract {
  methods: BTokenScenarioMethods;
  name: string;
}
